%Without Jamming
function [OP1,OP2,OP1E,OP2E,cap_1,cap_2,cap_1E,cap_2E,cap_S1,cap_S2,gamma1f,gamma2f]=OP_cap_d4(m1,omega1,m2,omega2,m3,omega3,m4,omega4,m6,omega6,NO,gammadbCU1,gammadbCU2,gammadbCU3,Psdb,P1db,NOL,alpha1,alpha2)
...
for jj=1:length(omega4)
    ...
    cap_2E(jj)=0; %secrecy capacity of eavesdropper against user1.
    gamma1f(jj)=0;
    gamma2f(jj)=0;
    gamma3f(jj)=0;
    gamma4f(jj)=0;
    ...
    for ii=1:NOL
        ...
        X5=0; % without jamming, so there will be no jamming link.
